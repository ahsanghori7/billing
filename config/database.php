...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION_BILLING', 'billing'),
    ...
    */
    ...
    'connections' => [
        ...
        'integration' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_INTEGRATION', '127.0.0.1'),
            'port' => env('DB_PORT_INTEGRATION', '3306'),
            'database' => env('DB_DATABASE_INTEGRATION', 'forge'),
            'username' => env('DB_USERNAME_INTEGRATION', 'forge'),
            'password' => env('DB_PASSWORD_INTEGRATION', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
