...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('integration')->create('batelco_mt_notification', function (Blueprint $table) {
    ...
    {
        Schema::connection('integration')->dropIfExists('batelco_mt_notification');
    }
};
