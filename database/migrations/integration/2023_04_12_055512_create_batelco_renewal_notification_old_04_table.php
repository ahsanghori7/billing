...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('integration')->create('batelco_renewal_notification_old_04', function (Blueprint $table) {
    ...
    {
        Schema::connection('integration')->dropIfExists('batelco_renewal_notification_old_04');
    }
};
