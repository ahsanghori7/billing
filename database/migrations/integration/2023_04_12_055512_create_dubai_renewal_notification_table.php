...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('integration')->create('dubai_renewal_notification', function (Blueprint $table) {
    ...
    {
        Schema::connection('integration')->dropIfExists('dubai_renewal_notification');
    }
};
