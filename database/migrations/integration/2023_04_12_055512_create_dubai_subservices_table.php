...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('integration')->create('dubai_subservices', function (Blueprint $table) {
            ...
            $table->string('fallback_weekly_price', 88)->nullable();
    ...
    {
        Schema::connection('integration')->dropIfExists('dubai_subservices');
    }
};
