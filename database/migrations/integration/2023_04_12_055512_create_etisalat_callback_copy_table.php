...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('integration')->create('etisalat_callback_copy', function (Blueprint $table) {
            $table->integer('ID', true);
            $table->string('TransactionType', 88)->nullable()->index('TransactionType_2');
            ...
            $table->string('transaction_id1', 88)->nullable();
            ...
            $table->index(['TransactionType'], 'TransactionType');
    ...
    {
        Schema::connection('integration')->dropIfExists('etisalat_callback_copy');
    }
};
