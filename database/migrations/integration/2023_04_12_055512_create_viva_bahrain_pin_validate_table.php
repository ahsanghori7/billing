...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('integration')->create('viva_bahrain_pin_validate', function (Blueprint $table) {
    ...
    {
        Schema::connection('integration')->dropIfExists('viva_bahrain_pin_validate');
    }
};
