...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('integration')->create('viva_bahrain_renewal_notification_old_06', function (Blueprint $table) {
    ...
    {
        Schema::connection('integration')->dropIfExists('viva_bahrain_renewal_notification_old_06');
    }
};
